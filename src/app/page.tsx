    ...
    <>
      <header className='flex justify-between items-center flex-row py-5 px-8'>
        <div className='flex items-center'>
          <h1 className='font-archivo text-3xl font-semibold drop-shadow select-none'>&lt;Tony Terra Nova /&gt;</h1>
        </div>
          ...
          <div className='h-full w-1/2 flex items-center justify-center flex-col'>
            <div className='h-[50%] w-full flex flex-col justify-center pl-12'>
              ...
              <p className='mt-4 text-xl font-medium text-zinc-800'>
                ...
                Currently, I&apos;m seeking my first opportunity in software engineering, specializing in web
                development.
              </p>
            </div>
          </div>
      ...
      <section id='projects' className='flex justify-center items-center bg-brutalistYellow w-full h-dvh px-2'>
        <div className='w-full h-[90%] mx-8'>
          ...
          <div className='grid grid-cols-3 gap-16'>
            <div className='group'>
              <div
                className='w-[27rem] h-[17rem] relative bg-white border border-black rounded-md group-hover:bg-black
               group-hover:translate-x-[0.2rem] duration-200 ease-in-out'
              >
                <div
                  className='w-full h-[17rem] translate-x-[0.5rem] -translate-y-[0.5rem] bg-pokedexThumbnail border border-black rounded-md
            ...
            <div className='group'>
              ...
              >
                <div
                  className='w-full h-[17rem] translate-x-[0.5rem] -translate-y-[0.5rem] bg-red-600 border border-black rounded-md
                    group-hover:translate-x-[0.8rem] group-hover:-translate-y-[0.8rem] transition-transform duration-200 ease-in-out'
                ></div>
              </div>
            </div>
